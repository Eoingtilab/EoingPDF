...
assert window.pages == [1, 0, 2] and window.page.value() == 1 and window.dirty
window.toggle_sidebar_mode()
assert not window.thumbnail_mode and window.thumbnails.item(0).text()
window.toggle_sidebar_mode()
assert window.thumbnail_mode
window.load(source)
window.page.setValue(2)
