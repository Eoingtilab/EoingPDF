...
- **파일 내용을 서버로 전송하지 않습니다.** 모든 변환·병합·요약은 사용자 PC에서만 처리됩니다.
- **사용자를 추적하지 않습니다.** IP, 기기명, 하드웨어 정보를 수집하거나 저장하지 않습니다.
- **원본을 건드리지 않습니다.** 모든 작업 결과는 항상 새 파일로 저장되며 원본은 그대로 보존됩니다.
- **오픈소스입니다.** 이 저장소 전체가 AGPL-3.0으로 공개되어 있어 누구나 코드를 직접 확인할 수 있습니다.
- **관공서·개인 사용자에게 무료입니다.**
...
"이 프로젝트는 GNU AGPL-3.0 라이선스로 배포됩니다"
